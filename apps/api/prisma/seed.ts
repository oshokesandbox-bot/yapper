...
async function main() {
  ...
  const recommendations = [
    ...
    // ── Expanded Spanish ──
    { id: "es-romancero", language: "ES" as const, title: "El Romancero Gitano", mediaType: "book", stageHintId: 1, reason: "Poetry with strong rhythm and repeated refrains — great for musical ear training in Spanish.", challenge: "Read one poem aloud and notice repeated vowel patterns.", affiliateUrl: "https://www.amazon.com/Romancero-gitano-Federico-Garcia-Lorca/dp/8420674127" },
    { id: "es-nadie-es-perfecto", language: "ES" as const, title: "Nadie es perfecto (Podcast)", mediaType: "podcast", stageHintId: 1, reason: "Clear conversational Spanish with both native and learner speakers — natural dialogue cadence.", challenge: "Listen to the first 5 minutes and write down 3 words you heard more than once." },
    { id: "es-luis-fonsi", language: "ES" as const, title: "Despacito — Luis Fonsi", mediaType: "music", stageHintId: 1, reason: "Ubiquitous pop song with clear, repetitive lyrics and a slow chorus.", challenge: "Listen without subtitles and identify the chorus phrase that repeats most.", affiliateUrl: "https://www.youtube.com/playlist?list=PLSzYqkXKjK4Jr1Kj6d8fXq7Ql7Z7Z7Z7Z" },
    { id: "es-el-laberinto", language: "ES" as const, title: "El Laberinto del Fauno", mediaType: "movie", stageHintId: 1, reason: "Spanish-language fantasy with strong visual narrative, making it easier to infer meaning.", challenge: "Watch a 5-minute scene and identify the emotional tone of each character exchange." },
    // ── Expanded French ──
    { id: "fr-intouchables", language: "FR" as const, title: "Les Intouchables", mediaType: "movie", stageHintId: 1, reason: "Modern French classic with natural dialogue, humor, and strong non-verbal cues.", challenge: "Watch the opening 10 minutes and describe the relationship dynamic between the two characters.", affiliateUrl: "https://www.amazon.com/Intouchables-Omar-Sy/dp/B007VBJEGU" },
    { id: "fr-inner-french", language: "FR" as const, title: "InnerFrench (Podcast)", mediaType: "podcast", stageHintId: 1, reason: "Deliberately slow, clear French with cultural topics — perfect for building listening stamina.", challenge: "Listen to one episode without pausing and note every moment you understood a full sentence." },
    { id: "fr-kaamelott", language: "FR" as const, title: "Kaamelott — Livre I", mediaType: "series", stageHintId: 1, reason: "Cult French comedy series with short episodes, exaggerated acting, and repetitive situational humor.", challenge: "Watch one short episode and identify the running joke from visual cues alone." },
    { id: "fr-stromae", language: "FR" as const, title: "Stromae — Tous les mêmes", mediaType: "music", stageHintId: 1, reason: "Electro-pop with clear French lyrics and a music video that reinforces meaning through visuals.", challenge: "Watch the music video and write down three emotion words the song conveys." },
    // ── Expanded English ──
    { id: "en-bbc-6min", language: "EN" as const, title: "BBC 6 Minute English", mediaType: "podcast", stageHintId: 1, reason: "Short, scripted conversations on accessible topics with vocabulary breakdowns built in.", challenge: "Listen to one episode and repeat each key phrase out loud after hearing it." },
    { id: "en-disney-basics", language: "EN" as const, title: "Disney Nature — Penguins", mediaType: "movie", stageHintId: 1, reason: "Narrated nature documentary with slow, clear English narration and predictable sentence patterns.", challenge: "Watch 5 minutes and count how many times the narrator uses a present-tense verb.", affiliateUrl: "https://www.disneyplus.com/movies/disney-nature-penguins" },
    { id: "en-the-economist", language: "EN" as const, title: "The Economist Espresso", mediaType: "book", stageHintId: 1, reason: "Concise daily briefing with rich vocabulary in short, digestible paragraphs.", challenge: "Read one briefing and underline every adjective you understand in context." },
    { id: "en-queen", language: "EN" as const, title: "Queen — Bohemian Rhapsody", mediaType: "music", stageHintId: 1, reason: "Iconic song with varied vocal delivery, clear English phrases, and a story-driven structure.", challenge: "Listen and write down the first sentence that paints a vivid mental picture." },
    // ── Expanded German ──
    { id: "de-nicos-weg", language: "DE" as const, title: "Nicos Weg — Deutsche Welle", mediaType: "series", stageHintId: 1, reason: "Free, graded video series designed for German learners — scaffolded from A1.", challenge: "Watch the A1 episode and list every time you hear 'und' or 'ja'.", affiliateUrl: "https://learngerman.dw.com/en/course/nicos-weg/" },
    { id: "de-slow-german", language: "DE" as const, title: "Slow German (Podcast)", mediaType: "podcast", stageHintId: 1, reason: "Deliberately paced German podcast with transcripts and cultural topics.", challenge: "Listen to one episode at normal speed first, then read the transcript after." },
    { id: "de-rammstein", language: "DE" as const, title: "Rammstein — Sonne", mediaType: "music", stageHintId: 1, reason: "Slow, heavy articulation makes each word distinct — surprisingly accessible for listening practice.", challenge: "Listen to the chorus and write down every word you can identify." },
    { id: "de-lola-rennt", language: "DE" as const, title: "Lola rennt (Run Lola Run)", mediaType: "movie", stageHintId: 1, reason: "Fast-paced but highly visual German film with repeated scenes — great for pattern recognition.", challenge: "Watch the first sequence and identify the sound that signals something important." },
    // ── Expanded Russian ──
    { id: "ru-russian-podcast", language: "RU" as const, title: "Russian Podcast for Beginners", mediaType: "podcast", stageHintId: 1, reason: "Slow, simplified Russian with clear topic framing and repetition.", challenge: "Listen to the first 3 minutes and write down all the words you recognize from visual context alone." },
    { id: "ru-nu-pogodi", language: "RU" as const, title: "Nu, Pogodi! (Ну, погоди!)", mediaType: "series", stageHintId: 1, reason: "Beloved Russian cartoon with minimal dialogue and exaggerated physical comedy.", challenge: "Watch one episode without subtitles and describe what happened using just gestures." },
    { id: "ru-kalinka", language: "RU" as const, title: "Kalinka — Ivan Larionov", mediaType: "music", stageHintId: 1, reason: "Classic Russian folk song with a repetitive chorus that drills core vowel sounds.", challenge: "Try to sing the chorus and count how many times the title word appears." },
    { id: "ru-moskva-slezam", language: "RU" as const, title: "Москва слезам не верит", mediaType: "movie", stageHintId: 1, reason: "Iconic Soviet film with clear emotional cues and strong visual storytelling.", challenge: "Watch a 5-minute scene and describe the characters' relationships from body language." }
  ];
